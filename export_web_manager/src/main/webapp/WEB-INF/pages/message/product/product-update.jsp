    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/message/product/edit.do" method="post">
                <input type="text" id="deptName" name="id" value="${product.id}">
                <div class="row data-type" style="margin: 0px">
                    ...
                    <c:if test="${not empty product.productImage && !(product.productImage eq null) }">
                        <div class="col-md-2 title">商品照片</div>
                        <div class="col-md-4 data">
                            <c:if test="${not empty product.productImage && !(product.productImage eq null) }">
                                <img src="${product.productImage}" width="300px" height="180px">
                                <input type="hidden" name="productImage" value="${product.productImage}">
                            </c:if>
                        </div>
                    </c:if>
                    <c:if test="${empty product.productImage || (product.productImage eq null) }">
                        <div class="col-md-2 title">商品照片</div>
                        <div class="col-md-4 data">
                            还没有照片
                        </div>
                    ...
                    <div class="col-md-4 data  rowHeight2x">
                        <textarea class="form-control" rows="3" placeholder="描述" name="description">${product.description}</textarea>
                    </div>
                </div>
            </form>
        </div>
