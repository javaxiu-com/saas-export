    ...
    function deleteById() {
        ...
        if(id) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/message/product/delete.do?id="+id;
            }
        }else{
                ...
                <div class="table-box">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/message/product/toAdd.do"'><i class="fa fa-file-o"></i> 新建</button>
