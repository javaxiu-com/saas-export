...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <!-- 正文区域 -->
        ...
        <form id="editForm" action="${ctx}/cargo/packing/edit.do" method="post">
            ...
            <div class="panel-heading">修改装箱信息</div>
        ...
        <div class="box box-primary">
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${eps}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                ...
                                <td>
                                    <c:if test="${o.state==3}">
                                        <input type="checkbox"  name="exportIds" value="${o.id}" checked="checked"/>
                                    </c:if>
                                </td>
                                ...
                                <td>
                                    ...
                                    <c:if test="${o.state==4}"><font color="red">已装箱</font></c:if>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
            ...
            <div class="box-footer">
                <jsp:include page="../../common/page.jsp">
                    <jsp:param value="cargo/packing/toUpdate.do" name="pageUrl"/>
                </jsp:include>
            </div>
